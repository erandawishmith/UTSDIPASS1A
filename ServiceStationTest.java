...
public class ServiceStationTest {
    ...
    public static void main(String[] args) {
        ...
        // Display the updated list of services
        test.displayServices();
    }

    private void addTestServices() {
        // Add some test services to the LinkedList
        services.add(new Service(1, "John Doe", "Car Model", "2023-01-15", ServiceType.FULL_SERVICE, Status.Booked));
        services.add(new Service(2, "Alice Smith", "SUV Model", "2023-02-20", ServiceType.BODYWASH, Status.Finished));
        services.add(new Service(3, "Bob Johnson", "Truck Model", "2023-03-25", ServiceType.OIL_CHANGE, Status.Processing));
    }
    ...
    private void editService() {
        ...
        if (serviceToEdit != null) {
            ...
            // Collect new details for the service
            ...
            // Update the service in the LinkedList
